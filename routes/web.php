...
Route::get('/qr-code','QrcodeController@index')->name('add-qr-code');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('productCategories/remove-media', 'ProductCategoryController@removeMedia');
    ...
    Route::post('products/add-stock', 'ProductController@addStock');
...
//    Discover
    Route::resource('banner-package', 'BannerPackageController');
    Route::post('bannerPackage/remove-media', 'BannerPackageController@removeMedia');
    Route::resource('hashtag', 'BannerPackageHashController');
    Route::post('bannerPackageHash/remove-media', 'BannerPackageHashController@removeMedia');

//    packages
    Route::resource('premium-banner-package', 'PremiumBannerPackageController');
    Route::post('premium-banner-package/remove-media', 'PremiumBannerPackageController@removeMedia');

    Route::resource('premium-gallery-package', 'PremiumGalleryPackageController');
    Route::post('premium-gallery-package/remove-media', 'PremiumGalleryPackageController@removeMedia');

    Route::resource('coin-package', 'CoinPackageController');
});
