...
{{--Discover--}}
<li class="nav-item has-treeview {{ Request::is('banner-package*') || Request::is('hashtag*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{  Request::is('banner-package*') ? 'active' : '' }}"> @if($icons)
            <i class="nav-icon fas fa-wallet"></i>@endif
        <p>{{trans('lang.discover_plural')}} <i class="right fas fa-angle-left"></i>
        </p>
    </a>
    <ul class="nav nav-treeview">
        @can('banner-package.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('banner-package*') ? 'active' : '' }}" href="{!! route('banner-package.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-list"></i>@endif
                    <p>{{trans('lang.banner_list')}}</p></a>
            </li>
        @endcan
            @can('hashtag.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('hashtag*') ? 'active' : '' }}" href="{!! route('hashtag.index') !!}">@if($icons)
                            <i class="nav-icon fas fa-list"></i>@endif
                        <p>{{trans('lang.hash_list')}}</p></a>
                </li>
            @endcan
...
@endcan
<li class="nav-item {{ Request::is('productCategories*') || Request::is('products*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('products*') || Request::is('productCategories*') ? 'active' : '' }}"> @if($icons)
            <i class="nav-icon fas fa-question-circle"></i>@endif
        <p>{{trans('lang.inventory')}} <i class="right fas fa-angle-left"></i>
        </p>
    </a>
    <ul class="nav nav-treeview">
        @can('productCategories.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('productCategories*') ? 'active' : '' }}" href="{!! route('productCategories.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-folder-open"></i>@endif<p>{{trans('lang.product_categories')}}</p></a>
            </li>
        @endcan
        ...
        @can('products.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('products*') ? 'active' : '' }}" href="{!! route('products.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-life-ring"></i>@endif
                    <p>{{trans('lang.products')}}</p></a>
            </li>
        @endcan
    </ul>
</li>
<li class="nav-item {{ Request::is('premium-banner-package*') || Request::is('coin-package*') || Request::is('premium-gallery-package*') ? 'menu-open' : '' }}">
    <a href="#" class="nav-link {{ Request::is('coin-package*') || Request::is('premium-banner-package*') || Request::is('premium-gallery-package*') ? 'active' : '' }}"> @if($icons)
            <i class="nav-icon fas fa-question-circle"></i>@endif
        <p>{{trans('lang.package_plural')}} <i class="right fas fa-angle-left"></i>
        </p>
    </a>
    <ul class="nav nav-treeview">
        @can('premium-banner-package.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('premium-banner-package*') ? 'active' : '' }}" href="{!! route('premium-banner-package.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-folder-open"></i>@endif<p>{{trans('lang.premium')}} {{trans('lang.package')}}</p></a>
            </li>
        @endcan

        @can('premium-gallery-package.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('premium-gallery-package*') ? 'active' : '' }}" href="{!! route('premium-gallery-package.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-photo-video"></i>@endif<p>{{trans('lang.premium')}} {{trans('lang.gallery')}}</p>
                </a>
            </li>
        @endcan

        @can('coin-package.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('coin-package*') ? 'active' : '' }}" href="{!! route('coin-package.index') !!}">@if($icons)
                        <i class="nav-icon fas fa-life-ring"></i>@endif
                    <p>{{trans('lang.coin')}} {{trans('lang.package_plural')}}</p></a>
            </li>
        @endcan
    </ul>
</li>
