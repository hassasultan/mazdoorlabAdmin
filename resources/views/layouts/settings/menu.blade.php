 ...
 ? '' : 'collapsed-card' }}">
    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            @can('coins.index')
                <li class="nav-item">
                    <a href="{!! url('settings/coin/edit') !!}" class="nav-link {{ Request::is('settings/coin*') ? 'selected' : '' }}"><i class="nav-icon fas fa-dollar-sign ml-1"></i>{{trans('lang.coin_singular')}}
                    </a>
                </li>
            @endcan
