...
<div class="d-flex flex-column col-sm-12 col-md-6">
            ...
            var dz_var16110647911349350349ble = $(".dropzone.image").dropzone({
                    ...
                    removedfile: function (file) {
                        dzRemoveFileMultiple(
                            file, var16110647911349350349ble, '{!! url("bannerPackage/remove-media") !!}',
                            'image', '{!! isset($banner_package) ? $banner_package->id : 0 !!}', '{!! url("uploads/clear") !!}', '{!! csrf_token() !!}'
                        );
                    }
                });
    ...
    <div class="form-group align-items-baseline d-flex flex-column flex-md-row">
        ...
        <div class="col-md-9">
            {!! Form::select('status', ['draft'=>'Draft','publish'=>'Publish'], isset($banner_package)?$banner_package->status:null, ['data-empty'=>trans("lang.product_category_status"), 'class' => 'select2 required form-control']) !!}
        </div>
    </div>
</div>
@if($customFields)
...
<div class="form-group col-12 d-flex flex-column flex-md-row justify-content-md-end justify-content-sm-center border-top pt-4">
    <button type="submit" class="btn bg-{{setting('theme_color')}} mx-md-3 my-lg-0 my-xl-0 my-md-0 my-2">
        <i class="fa fa-save"></i> {{trans('lang.save')}} {{trans('lang.discover_bannername')}}
    </button>
    <a href="{!! route('banner-package.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.cancel')}}</a>
</div>
