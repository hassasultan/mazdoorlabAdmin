            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb bg-white float-sm-right rounded-pill px-4 py-2 d-none d-md-flex">
                        ...
                        <li class="breadcrumb-item active">{{trans('lang.edit')}} {{trans('lang.package')}}</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card-header">
                <ul class="nav nav-tabs d-flex flex-row align-items-start card-header-tabs">
                    ...
                    @can('premium-banner-package.create')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! route('premium-banner-package.create') !!}"><i class="fas fa-plus mr-2"></i>{{trans('lang.create')}} {{trans('lang.premium')}} {{trans('lang.package')}}
                            </a>
                        </li>
                    @endcan
                    <li class="nav-item">
                        <a class="nav-link active" href="{!! url()->current() !!}"><i class="fas fa-edit mr-2"></i>{{trans('lang.edit')}} {{trans('lang.premium')}} {{trans('lang.package')}}</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
                {!! Form::model($premium_package, ['route' => ['premium-banner-package.update', $premium_package->id], 'method' => 'patch']) !!}
                <div class="row">
