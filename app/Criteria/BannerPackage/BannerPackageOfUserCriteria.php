...
namespace App\Criteria\BannerPackage;
 ...
 */
class BannerPackageOfUserCriteria implements CriteriaInterface
{
    /**
     * @var int
     */
    ...
    {
        return $model->select('banner_packages.*')->groupBy('banner_packages.id');
    }
}
