...
class PremiumBannerPackageDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->addColumn('action', 'premium_banner_packages.datatables_actions')
    ...
    protected function getColumns()
    {
        ...
        $hasCustomField = in_array(PremiumBannerPackage::class, setting('custom_field_models', []));
        if ($hasCustomField) {
            $customFieldsCollection = DB::table('custom_fields')->where('custom_field_model', PremiumBannerPackage::class)->where('in_table', '=', true)->get();
     ...
     */
    public function query(PremiumBannerPackage $model)
    {
    ...
    {
        return 'premium_banner_packages_datatable_' . time();
    }
}
